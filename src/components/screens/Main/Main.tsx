  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.content}>
        ...
        {/*        <div>*/}
        {/*          <div className={styles.odd}>*/}
        {/*            <div className={styles.oddName}>1</div>*/}
        {/*            <div className={styles.oddNum}>1.69</div>*/}
        {/*          </div>*/}
        {/*          <div className={styles.odd}>*/}
        {/*            <div className={styles.oddName}>x</div>*/}
        {/*            <div className={styles.oddNum}>1.69</div>*/}
        {/*          </div>*/}
        {/*          <div className={styles.odd}>*/}
        {/*            <div className={styles.oddName}>2</div>*/}
        {/*            <div className={styles.oddNum}>1.69</div>*/}
        {/*          </div>*/}
        {/*        </div>*/}
        {/*      </div>*/}
        ...
        {/*        <div>*/}
        {/*          <div className={styles.odd}>*/}
        {/*            <div className={styles.oddName}>1x</div>*/}
        {/*            <div className={styles.oddNum}>1.16</div>*/}
        {/*          </div>*/}
        {/*          <div className={styles.odd}>*/}
        {/*            <div className={styles.oddName}>12</div>*/}
        {/*            <div className={styles.oddNum}>1.33</div>*/}
        {/*          </div>*/}
        {/*          <div className={styles.odd}>*/}
        {/*            <div className={styles.oddName}>2x</div>*/}
        {/*            <div className={styles.oddNum}>2.33</div>*/}
        {/*          </div>*/}
        {/*        </div>*/}
        {/*      </div>*/}
        {/*      <div>*/}
        ...
        {/*        <div>*/}
        {/*          <div className={styles.odd}>*/}
        {/*            <div className={styles.oddName}>H1</div>*/}
        {/*            <div className={styles.oddNum}>1.16</div>*/}
        {/*          </div>*/}
        {/*          <div className={styles.anotherOdd}>*/}
        {/*            <svg className={styles.firstArrow} width="12" height="8" viewBox="0 0 12 8" fill="none"*/}
        {/*                 xmlns="http://www.w3.org/2000/svg">*/}
        {/*              <path d="M1.41 7.41L6 2.83L10.59 7.41L12 6L6 0L0 6L1.41 7.41Z" fill="#373737"/>*/}
        {/*            </svg>*/}
        {/*            <p className={styles.anotherOddName}>-1.5</p>*/}
        {/*            <svg className={styles.secondArrow} width="12" height="8" viewBox="0 0 12 8" fill="none"*/}
        {/*                 xmlns="http://www.w3.org/2000/svg">*/}
        {/*              <path d="M1.41 7.41L6 2.83L10.59 7.41L12 6L6 0L0 6L1.41 7.41Z" fill="#373737"/>*/}
        {/*            </svg>*/}
        {/*          </div>*/}
        ...
        <div className={styles.filtersContent}>
          <div>
            ...
            <div className={styles.filterItems}>
              ...
              {sports.map((sport, id) => (
                  <div key={sport.id}><p>{sport.name}</p></div>
                )
              )}</div>
          </div>
          <div>
            ...
            <div className={styles.filterItems}>{filters.filterItem.map((item, id) => (
              <div key={item.name} className={!id ? styles.active : ''}>{item.img.length ?
                <img src={item.img} alt=""/> : ''} <p>{item.name}</p></div>
            ))}</div>
          </div>
        </div>
      </div>
